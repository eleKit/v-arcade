...
public class ReplaySave : MonoBehaviour
{
	...
	/* in the filepath attribute it is assigned the path where to save the XML file
	 *  the path contains the word of the type of game: "Aereo", "Sci", "Musica"
	 */
	...
	/* in this method are saved to array containing Left_Hand and
	 * Right_Hand, these hands data are saved into two lists of type <SaveInfos.GameObjectInfos>
	 * and thed added to 4 attributes of class SaveInfos
	 */
