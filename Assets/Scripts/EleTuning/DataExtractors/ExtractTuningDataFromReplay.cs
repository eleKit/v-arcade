...
public class ExtractTuningDataFromReplay : MonoBehaviour
{
	...
	void Start ()
	{
		directoryPath = Path.Combine (Application.persistentDataPath, 
			Path.Combine ("Patients", Path.Combine ("Lina", GameMatch.GameType.Shooting.ToString ())));

		hand_data_file_path = Path.Combine (directoryPath, "Shooting_20181126T111825_hand_data.json");
